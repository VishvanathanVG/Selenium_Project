...
public class CreateLeadExcelDataProvider extends ProjectSpecificMethods {

	@DataProvider(name="createLeadData")
	public Object[][] sentData() throws IOException {
		
		ReadExcelDataProvider excelData = new ReadExcelDataProvider();
		String[][] readDataExcel = excelData.readDataExcel("CreateLeadExcelProvider");
		return readDataExcel;
		
	}
	
	@Test(dataProvider="createLeadData" ,priority=1)
	public void runCreateLead(String companyName,String firtsName, String latsName) {
